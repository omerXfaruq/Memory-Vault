class Constants:
    HELP_MESSAGE = (
        ...
        f"\n- You leave my system by, *leave* or */leave*"
        f"\n- You can get a random memory by, *send* or */send*"
        f"\n- You can get your status information by, *status* or */status*"
        f"\n- You can list memories by, *list* or */list*"
